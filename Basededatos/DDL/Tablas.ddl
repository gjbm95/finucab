...
CREATE TABLE Cuenta_Bancaria (Ct_id SERIAL NOT NULL, Ct_tipoCuenta varchar(255) NOT NULL, Ct_numCuenta varchar(255) NOT NULL, Ct_nombreBanco varchar(255) NOT NULL, Ct_saldoActual float4 NOT NULL, UsuarioU_id int4 NOT NULL, PRIMARY KEY (Ct_id));
CREATE TABLE Pago (Pg_id SERIAL NOT NULL,Pg_monto float4 NOT NULL,Pg_fecha date NOT NULL,Pg_descripcion varchar(1000) NOT NULL, Pg_tipoTransaccion varchar(255) NOT NULL, CategoriaCa_id int4 NOT NULL, PRIMARY KEY (Pg_id));
