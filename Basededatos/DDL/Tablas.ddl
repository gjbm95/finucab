...
CREATE TABLE Tarjeta_Credito (Tc_id SERIAL NOT NULL, Tc_tipo varchar(255) NOT NULL, Tc_fechaVencimiento date NOT NULL, Tc_numero varchar(255) NOT NULL, Tc_saldo int4 NOT NULL, UsuarioU_id int4 NOT NULL, PRIMARY KEY (Tc_id));
