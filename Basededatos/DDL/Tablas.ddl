CREATE TABLE Categoria (Ca_id SERIAL NOT NULL, Ca_nombre varchar(255) NOT NULL, C_descripcion varchar(1000) NOT NULL, Ca_eshabilitado bool NOT NULL, Ca_esingreso bool NOT NULL, PlanificacionPa_id int4 NOT NULL, PRIMARY KEY (Ca_id));
...
CREATE TABLE Pago (Pg_id SERIAL NOT NULL, Pg_descripcion varchar(1000) NOT NULL, Pg_tipoTransaccion varchar(255) NOT NULL, CategoriaCa_id int4 NOT NULL, PRIMARY KEY (Pg_id));
...
CREATE TABLE Usuario (U_id SERIAL NOT NULL, U_usuario varchar(50) NOT NULL UNIQUE, U_password int4 NOT NULL, U_nombre varchar(50) NOT NULL, U_apellido varchar(50) NOT NULL, U_correo varchar(100) NOT NULL, U_pregunta varchar(1000) NOT NULL, U_respuesta varchar(1000) NOT NULL, PRIMARY KEY (U_id));
