...
CREATE TABLE Presupuesto (Pr_id SERIAL NOT NULL, Pr_nombre varchar(255) NOT NULL, Pr_monto float4 NOT NULL,Pr_fecha date NOT NULL, Pr_clasificacion varchar(255) NOT NULL, Pr_duracion int4 NOT NULL, UsuarioU_id int4, CategoriaCa_id int4 NOT NULL, PRIMARY KEY (Pr_id));
