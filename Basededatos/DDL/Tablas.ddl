CREATE TABLE Categoria (Ca_id SERIAL NOT NULL, Ca_nombre varchar(255) NOT NULL, C_descripcion varchar(1000) NOT NULL, Ca_eshabilitado bool NOT NULL, Ca_esingreso bool NOT NULL, PlanificacionPa_id int4 NOT NULL, UsuarioU_id int4 NOT NULL, PRIMARY KEY (Ca_id));
