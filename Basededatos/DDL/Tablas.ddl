...
CREATE TABLE Pago (Pg_id SERIAL NOT NULL,Pg_monto float4 NOT NULL,Pg_fecha date NOT NULL,Pg_descripcion varchar(1000) NOT NULL, Pg_tipoTransaccion varchar(255) NOT NULL, CategoriaCa_id int4 NOT NULL, UsuarioU_id int4, PRIMARY KEY (Pg_id));
...
CREATE TABLE Presupuesto (Pr_id SERIAL NOT NULL, Pr_nombre varchar(255) NOT NULL, Pr_monto float4 NOT NULL,Pr_fecha float4 NOT NULL, Pr_clasificacion varchar(255) NOT NULL, Pr_duracion int4 NOT NULL, UsuarioU_id int4, CategoriaCa_id int4 NOT NULL, PRIMARY KEY (Pr_id));
