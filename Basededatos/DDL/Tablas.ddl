...
CREATE TABLE Pago (Pg_id SERIAL NOT NULL,Pg_monto float4 NOT NULL,Pg_descripcion varchar(1000) NOT NULL, Pg_tipoTransaccion varchar(255) NOT NULL, CategoriaCa_id int4 NOT NULL, PRIMARY KEY (Pg_id));
...
CREATE TABLE Tarjeta_Credito (Tc_id SERIAL NOT NULL, Tc_tipo varchar(255) NOT NULL, Tc_fechaVencimiento date NOT NULL, Tc_numero varchar(255) NOT NULL, Tc_saldo int4 NOT NULL, Cuenta_BancariaCt_id int4 NOT NULL, PRIMARY KEY (Tc_id));
