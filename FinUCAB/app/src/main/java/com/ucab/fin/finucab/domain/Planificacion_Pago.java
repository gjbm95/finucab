...
public class Planificacion_Pago {
    ...
    public void modificarPlanificacion(Planificacion planificacion){
        ...
        Parametros.reset();
        Parametros.setMetodo("Modulo6/modificarPlanificacion?datosPlanificacion=" + URLEncoder.encode(object.toString
                ()));
        new Recepcion(activity, interfaz).execute("GET");
