...
public class Seccion extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setIcon(R.drawable.indicador);
        */
        //Editando la barra superior (Action Bar):
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setLogo(R.drawable.indicador);
        toolbar.setTitle(" Nombre_Seccion");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_perfil) {
            ...
            cerrar = new Intent(Seccion.this,Principal.class);
        ...
        if (fragment != null) {
            ...
            ft.replace(R.id.content_seccion, fragment);
            ft.commit();
        }
